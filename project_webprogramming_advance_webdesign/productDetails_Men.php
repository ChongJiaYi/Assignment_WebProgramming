...
@media only screen and (max-width: 600px) {
  ...
  <div class="all_part">
    <div class="all_part_left">
        ...
        <div class="title">
              <h3>Men Cloth</h3>
              <p>Showing results for Men's Cloth</p>
        </div>
    </div>
        ...
        <form action="" method="post">
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-footer d-flex justify-content-between bg-light border">
                    ...
                    <a href="productDescription_Men.php" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                    <a href="shopping_cart.php" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                    <input type="hidden" name="product_id" value="<?php echo $row['MEN_CODE']; ?>">
                </div>
            </div>
        </form>
    </div>
